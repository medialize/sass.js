module.exports = function GruntfileConcat(grunt) {
  ...
  grunt.config('concat', {
    ...
    worker: {
      src: ['libsass/libsass/lib/libsass.js', 'src/util.js', 'src/sass.options.js', 'src/sass.importer.js', 'src/sass.api.js', 'src/sass.worker.js'],
    ...
    sync: {
      src: ['libsass/libsass/lib/libsass.js', 'src/util.js', 'src/sass.options.js', 'src/sass.importer.js', 'src/sass.api.js'],
